...
public class linkedGrid {
    ...
    public void tour(Node n, int counter){
        ...
        if( (n.getUp() != null) && (n.getUp().getLeft() != null) && (n.getUp().getLeft().getLeft() != null) && n.getUp().getLeft().getLeft().getC() == 0){
            tour(n.getUp().getLeft().getLeft(), counter+1);
        }
        if( (n.getDown() != null) && (n.getDown().getLeft() != null) && (n.getDown().getLeft().getLeft() != null) && n.getDown().getLeft().getLeft().getC() == 0){
            tour(n.getDown().getLeft().getLeft(), counter+1);
        }
        if( (n.getDown() != null) && (n.getDown().getDown() != null) && (n.getDown().getDown().getLeft() != null) && n.getDown().getDown().getLeft().getC() == 0){
            tour(n.getUp().getUp().getLeft(), counter+1);
        }
        if( (n.getUp() != null) && (n.getUp().getUp() != null) && (n.getUp().getUp().getLeft() != null) && n.getUp().getUp().getLeft().getC() == 0){
            tour(n.getUp().getUp().getLeft(), counter+1);
